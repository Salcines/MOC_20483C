...
namespace School
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void saveChanges_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                //If the user has changed the same student earlier, then overwrite their changes with the nuew data
            ...
            {
                //If some sort of database exception has ocurred, then display the reason for the exception and rollerback
